...
public class NilsimsaTest {
    ...
    private static final int[][] REFERENCE_DISTANCE = {
        {
            0, 134, 123, 132, 134, 126, 136, 129, 136,
        },
        {
            134, 0, 99, 118, 120, 114, 112, 111, 112,
        },
        {
            123, 99, 0, 113, 107, 103, 111, 106, 109,
        },
        {
            132, 118, 113, 0, 110, 112, 114, 115, 112,
        },
        {
            134, 120, 107, 110, 0, 110, 110, 105, 106,
        },
        {
            126, 114, 103, 112, 110, 0, 108, 99, 98,
        },
        {
            136, 112, 111, 114, 110, 108, 0, 91, 122,
        },
        {
            129, 111, 106, 115, 105, 99, 91, 0, 95,
        },
        {
            136, 112, 109, 112, 106, 98, 122, 95, 0,
        },
    };
        ...
        for (String testData : TEST_DATA) {
            ...
            try {
                URL resource =
                        NilsimsaTest.class
                                .getClassLoader()
                                .getResource("wiki-" + testSet[1] + ".txt");
                documentContent =
                        new String(
                                Files.readAllBytes(Paths.get(resource.toURI())), CONTENT_ENCODING);
